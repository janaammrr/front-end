                          ...
                          : _videos.isEmpty
                              ? const Center(
                                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                                    ...
                                    SizedBox(height: 16),
                                    Text('No liked videos yet', style: TextStyle(color: Colors.white54, fontSize: 16, fontWeight: FontWeight.w600)),
                                    SizedBox(height: 8),
                                    Text('Like reels on the home feed to see them here.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white38, fontSize: 13)),
                                  ]),
                                )
                              : RefreshIndicator(
                                  onRefresh: _load,
...
class _VideoCard extends StatelessWidget {
  const _VideoCard({required this.video, required this.gradient, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          ReelThumbnail(thumbnailUrl: video.thumbnailUrl, fallbackGradient: gradient),
